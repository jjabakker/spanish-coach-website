...
3. **Words & Phrases** — practise adjectives, adverbs, numbers, greetings, and common expressions.
4. **Settings** — app and session preferences (Session Size, Learning Pace, Speech, …).
...
**Words & Phrases** is a simpler two-step section — [Select](../words-phrases/select/) your set, then [Test](../words-phrases/test/) with flashcards in either direction.

---

## Self Study vs Guided Lessons

If you want a structured curriculum that decides what to study next, see [Guided Lessons](../guided-lessons/) instead.
